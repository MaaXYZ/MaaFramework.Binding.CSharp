...
#pragma warning restore CA2213
    ...
    [SetsRequiredMembers]
    public MaaAgentClient(IMaaResource<MaaResourceHandle> resource, DisposeOptions disposeOptions)
        : this()
    {
        Resource = resource;
    ...
    public required IMaaResource<nint> Resource
    {
        ...
        set
        {
            ...
            MaaAgentClientBindResource(Handle, value.Handle).ThrowIfFalse(MaaInteroperationException.ResourceBindingFailedMessage);
            _resource = value;
        }
    }
